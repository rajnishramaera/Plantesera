          ...
          <div className="slide slide1">
           ...
           <div className="slide slide2" id="slider-2-4" style={{background:"linear-gradient(to right, #E4B980, #E2B87F)"}}>
            <div className="contentZoom">
              ...
              <h3 className="titleZoom">PlanetsEra’s Cumin Powder is an evergreen everyday Indian spice added to Indian food. A blend of spices for day-to-day  preparations in any vegetarian/non-vegetarian dish.</h3>
              {/* <button className="buttonZoomView">View</button> */}
            </div>
          </div>
        </div>
