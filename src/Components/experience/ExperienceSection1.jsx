    ...
    <>
      ...
      <div className="basis-6/12 pl-14 mobile-display">
        <div className="flex m-1 md:-m-2">
          <div className="flex flex-wrap">
            <div className="w-1/2 mr-3 ">
              <img loading="lazy" src={experience1} />
            </div>
          </div>

          <div className="flex flex-wrap">
            <div className="w-1/2 flex items-end">
              <img loading="lazy" src={experience2} />
            </div>
          </div>
        </div>
        <div className="flex md:-m-2">
          <div className="basis-4/12 mt-5 mr-3">
            <img loading="lazy" src={experience3} />
          </div>

          <div className="basis-4/12 mt-5 mr-3">
            <img loading="lazy" src={experience4} />
          </div>

          <div className="basis-4/12 mt-5 mr-3">
            <div className="basis-4/12">
              <img loading="lazy" src={experience5} />
            </div>
            <div className="basis-4/12">
              <img loading="lazy" src={experience6} />
            </div>
          </div>
        </div>
      </div>
