        ...
        <AccordionItem uuid="a">
          ...
          <AccordionItemPanel>
            ...
            <p>
              ...
              adipisicing elit. Ratione itaque molestias quod eum aliquid ab,
              laborum est blanditiis quibusdam! Aliquid quasi nobis quod
              architecto. Enim, voluptatem! Necessitatibus minus est maxime
              quia, sequi officiis obcaecati quae tenetur architecto impedit
              blanditiis illo magnam distinctio cum pariatur ullam facere ipsum
              ipsa, expedita ipsam? Id expedita doloremque, non voluptatibus a
              laboriosam facilis perspiciatis veniam eum fuga recusandae,
              obcaecati porro corporis officiis ea, adipisci deleniti! Alias
              quisquam minima recusandae quidem, aperiam debitis rem provident,
              aliquam asperiores quaerat tenetur, fugiat iste eos impedit soluta
              voluptatem
            </p>
          </AccordionItemPanel>
        </AccordionItem>
  ...
  <div className="basis-12/12 flex mt-16">
    ...
    <div className="basis-8/12">
      ...
      <p style={{ fontFamily: "myregular", color: "#75797f" }}>
        ...
        info@planetsera.com or by mail using the details provided below:
      </p>
      <br />
      <address>
        <span className="company">Planetsera Ltd.</span>
        <br />
        H-150 Sector 63 Noida UP
        <br />
        +91 123456899
        <br />
